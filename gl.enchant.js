...
/**
 * @scope enchant.gl.Bounding.prototype
 */
enchant.gl.Bounding = enchant.Class.create({
    /**
     * Sprite3Dの衝突判定を設定するクラス.
     * 点として定義されている.
     * enchant.gl.Boundingを継承したクラスとして, 
     * {@link enchant.gl.BS}, {@link enchant.gl.AABB},
     * {@link enchant.gl.OBB}, がある.
     * 現在, OBBはサポートされていない.
     * @constructs
     */
    initialize: function() {
    ...
    /**
     * 点との距離を計算する.
     * @param {enchant.gl.Bounding} bounding 衝突点オブジェクト
     * @return {Number}
     */
    ...
    /**
     * 球との距離を計算する.
     * @param {enchant.gl.BS} boudning 衝突球オブジェクト
     * @return {Number}
     */
     ...
     * @param {enchant.gl.AABB} bounding AABB
     * @return {Number}
     */
     ...
     * 回転する直方体との距離を計算する.
     * 現在, サポートされていない.
     * @param {enchant.gl.OBB} bounding OBB
     * @return {Number}
     */
     ...
     * @param {enchant.gl.Bounding|enchant.gl.BS|enchant.gl.AABB|enchant.gl.OBB} bounding 衝突判定オブジェクト
     * @return {Boolean}
     */
...
/**
 * @scope enchant.gl.BS.prototype
 */
enchant.gl.BS = enchant.Class.create(enchant.gl.Bounding, {
    /**
     * Sprite3Dの衝突判定を設定するクラス.
     * 球として定義されている.
     * @constructs
     * @see enchant.gl.Bounding
     */
    initialize: function() {
        enchant.gl.Bounding.call(this);
        this.type = 'BS';
        this.radius = 0.5;
    },
    toBounding: function(another) {
...
/**
 * @scope enchant.gl.AABB.prototype
 */
enchant.gl.AABB = enchant.Class.create(enchant.gl.Bounding, {
    /**
     * Sprite3Dの衝突判定を設定するクラス.
     * 回転しない立方体として定義されている.
     * @constructs
...
/**
 * @scope enchant.gl.OBB.prototype
 */
enchant.gl.OBB = enchant.Class.create(enchant.gl.Bounding, {
    /**
     * Sprite3Dの衝突判定を設定するクラス.
     * 回転するとして定義されている.
     * @constructs
